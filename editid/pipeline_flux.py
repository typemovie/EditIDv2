...
class PuLIDPipeline(nn.Module):
    def __init__(self, dit, device, weight_dtype=torch.bfloat16, onnx_provider='gpu', *args, **kwargs):
        ...
        self.app = FaceAnalysis(name='antelopev2', root='/dev_share/gdli7/models/insightface', providers=providers)
        self.app.prepare(ctx_id=0, det_size=(640, 640))
        self.handler_ante = insightface.model_zoo.get_model('/dev_share/gdli7/models/insightface/antelopev2/glintr100.onnx',
                                                            providers=providers)
